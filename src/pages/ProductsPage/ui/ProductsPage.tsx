  ...
  return (
    <Page background={ProductsPageBackground}>
      <VStack gap={1.25}>
        <CardText
          title='Products'
          text='Our MVP product called Virid Vision is a web-based platform that allows users to easily upload satellite images and view real-time information about their crops. Our platform provides crop classification, vegetation health analysis, yield prediction, and land use analysis, and utilizes pre-trained models and custom algorithms to process the satellite imagery. We also offer customization options to meet specific user needs.'
        />
